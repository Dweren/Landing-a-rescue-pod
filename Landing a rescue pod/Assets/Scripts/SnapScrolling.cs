...
public class SnapScrolling : MonoBehaviour
{
    ...
    private void Start()
    {
        panelCount = ListShips.Instance.listPrefabShips.Length;
        ...
        for (int i = 0; i < panelCount; i++)
        {
            ...
            instPanels[i].GetComponent<SelectShipPrefab>().selectShipID = i;
            instPanels[i].GetComponent<SelectShipPrefab>().selectMenu = selectMenu;
